...
public class Node {
    ...
    public void GetForce(VectorXD force)
    {
        ...
        force[index] += gravityForce.x + dampingForce.x;
        force[index + 1] += gravityForce.y + dampingForce.y;
        force[index + 2] += gravityForce.z + dampingForce.z;
    }
    ...
    public void GetForceJacobian(MatrixXD dFdx, MatrixXD dFdv)
    {
        ...
        // We assume that dumping force does not depend on x --> not symmetric terms
    }
